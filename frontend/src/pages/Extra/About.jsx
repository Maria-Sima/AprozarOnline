...
const About = () => {
  ...
  return (
    <div className="extrapage">
      <SingleBanner heading="About Us" bannerimage={banner} />
      ...
      <div className="pgleft pgcommon">
        ...
        <div>
          <h1>Our Goal</h1>
          <p>
            We prioritize working directly with local farmers and producers who share our values. By sourcing our
            products locally, we support the community and reduce our carbon footprint.
          </p>
        </div>
      </div>
      <Footer1 />
