...
import {initializeCart, removeFromCart, updateQuantity} from "../../reducers/cartReducer.js";
...
const ShoppingCart = () => {
    ...
    const increaseProductQuantity = (index) => {
        ...
        if (product) {
            dispatch(updateQuantity({ productId: product.productdata.id, quantity: product.quantity + 1 }));
            console.log(cartData)
