package com.codecool.backend.orders.payments.paypal;
...
@Autowired
    ...
    public AccessTokenResponseDTO getAccessToken() throws Exception {
        var request = HttpRequest.newBuilder()
                .uri(URI.create(PayPalEndpoints.createUrl(paypalConfiguration.getBaseUrl(), PayPalEndpoints.GET_ACCESS_TOKEN)))
    ...
    public OrderResponseDTO createOrder(OrderDTO orderDTO) throws Exception {
        ...
        var request = HttpRequest.newBuilder()
                .uri(URI.create(PayPalEndpoints.createUrl(paypalConfiguration.getBaseUrl(), PayPalEndpoints.ORDER_CHECKOUT)))
